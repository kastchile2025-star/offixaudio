# Créditos de fotografías y logotipos

Las fotografías provienen de [Wikimedia Commons](https://commons.wikimedia.org) y se usan bajo sus licencias. Ninguno de los autores respalda este sitio.

## Fotografías

| Archivo del sitio | Obra original | Autor | Licencia |
|---|---|---|---|
| `img/tocadiscos.jpg` | [Technics SL-1200 Original 1972](https://commons.wikimedia.org/wiki/File:Technics_SL-1200_Original_1972.jpg) | BMRR | CC BY-SA 4.0 |
| `img/amplificador.jpg` | [Sansui 9090DB amplifier](https://commons.wikimedia.org/wiki/File:Sansui_9090DB_amplifier_(colour_corrected_cutout).jpg) | Aaron Brick; recorte: Svjo; color: Ubcule | CC BY-SA 4.0 |
| `img/receiver.jpg` | [Sansui QRX-5500 Quadrophonic Receiver](https://commons.wikimedia.org/wiki/File:Sansui_QRX-5500_Quadrophonic_Receiver.jpg) | Davealexander | Dominio público |
| `img/cassettera.jpg` | [AKAI stack (cropped)](https://commons.wikimedia.org/wiki/File:AKAI_stack_(cropped).jpg) | Alexgroza | Dominio público |
...
Los logotipos en `img/marcas/` e `img/componentes/` provienen de Wikimedia Commons, donde están catalogados como dominio público (logos tipográficos sin umbral de originalidad). Las marcas pertenecen a sus respectivos propietarios y se muestran únicamente con fines de identificación de los equipos y componentes con los que trabaja este servicio técnico independiente.
